...
const productPaginationSort =   (req, res) => {
   ...
   var  sqlx = `select * from product ORDER BY id DESC LIMIT  ${startingLimit}, ${resultsPerPage} `;
...
module.exports = productPaginationSort;